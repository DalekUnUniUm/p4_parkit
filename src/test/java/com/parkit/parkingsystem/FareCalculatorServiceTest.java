...
public class FareCalculatorServiceTest {
    ...
    @Test
    public void calculateFareFreePark(){
        Date inTime = new Date();
    ...
    public void calculateFareCarWithDiscount(){
        ...
        fareCalculatorService.calculateFare(ticket);
        double discount = (0.75 * Fare.CAR_RATE_PER_HOUR) / 100 ;
        discount = discount * 5 ;
        System.out.println("Discount = " + ((0.75 * Fare.CAR_RATE_PER_HOUR) - discount));
    ...
    public void calculateFareBikeWithDiscount(){
        ...
        ticket.setDiscount(true);
        fareCalculatorService.calculateFare(ticket);
        double discount = (0.75 * Fare.BIKE_RATE_PER_HOUR) / 100 ;
        discount = discount * 5 ;
        System.out.println("Discount = " + ((0.75 * Fare.BIKE_RATE_PER_HOUR) - discount));
